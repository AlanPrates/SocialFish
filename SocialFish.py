...
def getLogin():
    ...
    elif url == 'https://github.com/AlanPrates/SocialFish':
...
def echo():
    ...
    if len(url) > 4 and len(red) > 4:
        ...
        url = 'https://github.com/AlanPrates/SocialFish'
        red = 'https://github.com/AlanPrates/SocialFish'
    cur = g.db
...
def main():
        ...
        # Inicia o banco
        initDB(DATABASE)
        app.run(host="18.236.175.113", port=5000)
